...
@keyframes flip-in-hor-bottom {
  ...
  100% {
    ...
    opacity: 1;
		...
		<!-- start: page -->
		<section class="body-sign flip-in-hor-bottom">
			<div class="center-sign">
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						<form action="slog.jsp" id="form" method="post">
							...
							<div class="form-group mb-lg">
								<label>Student Email<span class="required">*</span></label>
								<div class="input-group input-group-icon">
							...
							<p class="text-center">Don't have an account yet? <a href="sreg.jsp">Sign Up!</a>
						</form>
					</div>
				</div>
			</div>
