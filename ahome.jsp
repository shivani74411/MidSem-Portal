										...
										do{
											...
											<tbody>
												<tr class="gradeX">
													...
													<td class="actions">
														<a href="tconfirm.jsp?id=<%=id %>&email=<%=email%>&status=confirm" class="on-editing save-row"><i class="fa fa-check"></i></a>
														<a href="treject.jsp?id=<%=id %>&email=<%=email%>" class="on-editing cancel-row"><i class="fa fa-times"></i></a>
													</td>
												</tr>
											</tbody>
											<%
