			...
			<div class="center-sign flip-in-hor-bottom">
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						<form action="tlog.jsp" id="form" method="post">
							...
							<div class="form-group mb-lg">
								<label>Teacher Email<span class="required">*</span></label>
								<div class="input-group input-group-icon">
							...
							<p class="text-center">Don't have an account yet? <a href="treg.jsp">Sign Up!</a>
						</form>
					</div>
				</div>
			</div>
