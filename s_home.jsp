...
<%@include file="db.jsp" %>
	<head>
		...
		<script>  
			...
			var url="check1.jsp?subject="+subject+" ";
			...
			if(request.readyState==4){  
				...
				if(val1.match('no quiz found'))
					{
					alert("no quiz found according to your search");
					}  
				...
				<section role="main" class="content-body">
					...
					<section class="panel">
							<header class="panel-heading">
								<h2 class="panel-title">List Of Quiz Available</h2>
							</header>
								...
								<section class="panel">
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-7">
												<select id="company" onchange="searchInfo()" name="subject" class="form-control" required>
