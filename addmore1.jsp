		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					<div class="col-md-6">
							<form id="form" action="addques1.jsp" class="form-horizontal">
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<textarea name="question" rows="5" title="Your Question is too short" class="form-control" placeholder="Enter your Question" required></textarea>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="opta" class="form-control" placeholder="First Option" required/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="optb" class="form-control" placeholder="Second Option" required/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="optc" class="form-control" placeholder="Third Option" required/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="optd" class="form-control" placeholder="Fourth Option" required/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="ca" class="form-control" placeholder="Correct Option" required/>
											</div>
										</div>
									</div>
